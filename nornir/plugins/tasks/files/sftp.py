...
def get_dst_hash(task: TaskExecution, filename: str) -> str:
...
def compare_put_files(
    task: TaskExecution, sftp_client: paramiko.SFTPClient, src: str, dst: str
) -> List[str]:
    changed = []
...
def sftp(
    task: TaskExecution, src: str, dst: str, action: str, dry_run: Optional[bool] = None
) -> Result:
    """
